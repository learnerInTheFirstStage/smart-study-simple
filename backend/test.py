...
new_message = f'Based on the following content, {content}, generate a 7-day study plan for learning it, just containing day number, topic and one simple sentence of how to learn'
request_body = {
    "message": new_message,
    "mode": "chat",
}
...
if response3.status_code == 200:
    ...
    pattern = r"Day (\d+): (.*?)\n\"(.*?)\""
    plan_per_day = re.findall(pattern, cleaned_text)
    # print(plan_per_day)
    topics_data = []
